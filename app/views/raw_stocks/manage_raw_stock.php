...
<head>
    ...
    <title>Inventory Management</title>
     ...
     <link rel="stylesheet" href="../inventory/create-invoice.styles.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="product-registration">
                <h2 class="form-topic">Raw Material Registration</h2>
                <form id="product-form">
                    ...
                    <div class="form-group" id="category-group" style="display:none">
                        ...
                        <select id="category-select" name="category" required value="1">
                    ...
                    <div class="form-group" style="display:none">
                        ...
                        <input type="text" id="sinhala-product-name" name="sinhala-product-name" value="1" required>
                    </div>

                    <div class="form-group" style="display:none">
                        <label for="product-mrprice">Maximum Retail Price:</label>
                        <input type="text" id="product-mrprice" name="product-mrprice" value="1" required>
                    </div>

                    <div class="form-group" style="display:none">
                        <label for="product-price">Our Price:</label>
                        <input type="text" id="product-price" name="product-price" value="1" required>
                    </div>

                    <div class="form-group" style="display:none">
                        <label for="product-wprice">Wholesale Price:</label>
                        <input type="text" id="product-wprice" name="product-wprice" value="1" required>
                    </div>
                    ...
                    <div id="manual-item-list" style="display:none">
                ...
                <button type="button" class="delete-button">All Raw Materials</button>
            </div>

            <!-- Create Stock / GRN (Right Column) -->
            <div class="create-stock">
                <h2 class="form-topic">Create Raw Stock / GRN</h2>
                <form id="stock-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group2">
                            ...
                            <div id="qty-unit-group">
                                <input style="margin-top: 0px;" type="number" id="purchase-qty" name="purchase-qty" value=1>
                                <div class="form-group" id="unit-group" >
                                    <select id="unit-select" name="unit" style="display:none">
                                        
                                    </select>
                                    <!-- Plus Button -->
                                    <button type="button" id="add-unit-btn" style="display:none">+</button>
                                </div>
                            </div>
                    ...
                    <!-- Discount and Profit -->
                        ...
                        <div class="form-group-row">
                            ...
                            <div id="profit" style="display:none">
                    ...
                    <div id="stock-buttons">
                        ...
                        <button style="display:none" type="button" id="print-barcode-show-stock"><i class="fa fa-print print-icon"></i>Print Barcode</button>
                    </div>
                    <input type="text" class="eland-input" id="current_branch_stock" name="current_branch_stock" value="<?php echo $user_branch?>" hidden>
                </form>

                <table class="search-stock-table" style="display:none">
                    <thead>
                        <tr>
                            <th>Stock ID</th>
                            <th>Barcode</th>
                ...
                <div class="raw-stock-table-container">
                    <h3 id="all-stocks-text">All Raw Material Stocks</h3>
                    <div class="raw-stock-table-wrapper">
    ...
    <script src="../../assets/js/raw_inventory_script.js"></script>
</body>
</html>
